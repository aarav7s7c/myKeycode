...
function my_keydown(e)
{
	...
	console.log(keyPressed);
		...
		{
			aplhabetkey();
			document.getElementById("d1").innerHTML="You Pressed An Alphabat Key";
        ...
        if (keyPressed >=13 && keyPressed <=13 || keyPressed >=16 && keyPressed <=16 || keyPressed >=46 && keyPressed <=46)
	    {
		    otherkey();
